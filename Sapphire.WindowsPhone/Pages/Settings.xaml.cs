...
namespace Sapphire.Pages {
    ...
    public sealed partial class Settings : Page {
        ...
        private void EnableOneClickReblog_Toggled(object sender, RoutedEventArgs e) {
            UserPreferences.OneClickReblog = QuickPostAction.IsEnabled = (bool)OneClickReblog.IsChecked;
        }
        ...
        private void BlogNotiications_Click(object sender, RoutedEventArgs e) {
            Frame.Navigate(typeof(NotificationManager));
        }
    }
}
