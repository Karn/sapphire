...
namespace Core.Content {
    public class UserPreferences {
        ...
        public static bool ExplicitSearch {
            get {
                if (Settings.Values["_ExplicitSearch"] != null && !string.IsNullOrWhiteSpace(Settings.Values["_ExplicitSearch"].ToString()))
                    return Settings.Values["_ExplicitSearch"].ToString().Contains("T") ? true : false;
                return false;
            }
            set {
                Settings.Values["_ExplicitSearch"] = value ? "True" : "False";
            }
        }
    }
}
